...
solution "triangulate"
	...
	includedirs {
		...
		"/media/balazs/Data/Cornell/caffe/experiments/opencvbuiltbysean/OpenCV-2.1.0/include",
	    "/usr/include",
	}
	libdirs {
		"/usr/local/MATLAB/R2013b/bin/glnxa64",
		"/usr/local/MATLAB/R2013b/sys/os/glnxa64",
		"/media/balazs/Data/Cornell/caffe/experiments/opencvbuiltbysean/OpenCV-2.1.0/build/lib",
		"/usr/lib",
	}
	flags { "Symbols" }
	...
	links { "cxcore", "cv", "highgui", "freetype" }
