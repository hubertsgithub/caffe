...
EXPDIR=/media/balazs/Data/Cornell/caffe/experiments
...
export LD_LIBRARY_PATH=$EXPDIR/opencvbuiltbysean/OpenCV-2.1.0/build/lib:/usr/local/MATLAB/R2013b/bin/glnxa64:/usr/local/MATLAB/R2013b/sys/os/glnxa64:/usr/lib/x86_64-linux-gnu:/usr/lib:/usr/local/lib
