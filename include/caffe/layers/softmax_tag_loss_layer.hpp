#ifndef CAFFE_SOFTMAX_WITH_TAG_LOSS_LAYER_HPP_
#define CAFFE_SOFTMAX_WITH_TAG_LOSS_LAYER_HPP_
...
/**
 * @brief Computes the multinomial logistic loss for a many-of-many
...
class SoftmaxWithTagLossLayer : public LossLayer<Dtype> {
 public:
   /**
    ...
    */
  explicit SoftmaxWithTagLossLayer(const LayerParameter& param)
 ...
 protected:
  /// @copydoc SoftmaxWithTagLossLayer
...
#endif  // CAFFE_SOFTMAX_WITH_TAG_LOSS_LAYER_HPP_
